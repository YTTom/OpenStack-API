...
#python createVM.py createvm yt admin fbce8a2b-02fb-47b8-9d2f-9ddeda2ed75d 20ef3d07-ce9d-4156-b577-09b91b2d4e86 45c8adbf-5367-4064-a1b5-2f083c9ac0c7 9950c209-2c27-43c8-9e10-2b331ca9d225 JoeTestKeyPair 14d172c9-ac1c-44be-91b5-9e71df48cc2b,950831aa-0e71-40c3-96a0-7cd5e86f69d3  2 null 140.128.101.205 admin 1j6el4nj4su3 0 0
...
# volume create
vol1 = cinder.volumes.create(size=disk_size,name='volumes_'+server_name,imageRef=template_uuid)
...
#
server = nova.servers.create(name = server_name, image = None, block_device_mapping = block_dev_mapping, flavor = flavor.id, nics = nics, key_name = key_pair.name,availability_zone = host_name,)
